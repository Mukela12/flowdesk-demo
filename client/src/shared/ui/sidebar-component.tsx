    ...
    <div className="relative shrink-0 w-full">
      <div className="flex items-center p-1 w-full">
        ...
        <div className="px-2 py-1">
          <div className="font-sans text-[16px] text-neutral-50 font-semibold">
            Interfaces
          </div>
        </div>
      </div>
    ...
    <div className="w-full overflow-hidden transition-all duration-500" style={{ transitionTimingFunction: softSpringEasing }}>
      <div className="flex items-center justify-between">
        <div className="flex items-center h-10">
          <div className="px-2 py-1">
            <div className="font-sans text-[18px] text-neutral-50 font-semibold leading-[27px]">
              {title}
            </div>
          </div>
        </div>
      ...
      {!isCollapsed && (
        <div className="w-full mt-auto pt-2 border-t border-neutral-800">
          <div className="flex items-center gap-2 px-2 py-2">
            <AvatarCircle />
            <div className="text-[14px] text-neutral-50">Text content</div>
            <button
              type="button"
